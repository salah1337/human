...
function showvid1() {
  ...
  if (currentLanguage == 0) source.setAttribute("src", "https://media.githubusercontent.com/media/salah1337/human2/master/1.mp4");
  if (currentLanguage == 1) source.setAttribute("src", ".https://media.githubusercontent.com/media/salah1337/human2/master/1.mp4");
...
function showvid2() {
  ...
  if (currentLanguage == 0) source.setAttribute("src", "https://media.githubusercontent.com/media/salah1337/human1/main/0.mp4");
  if (currentLanguage == 1) source.setAttribute("src", "https://media.githubusercontent.com/media/salah1337/human1/main/0-en.mp4");
